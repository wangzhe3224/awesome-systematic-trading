...
可以用快捷查找方式找到相关的libraries，比如：`Ctrl+F`, `Rust`
 ...
 - [Awesome Systematic Trading](#awesome-systematic-trading)
   - [回测 + 实时交易](#backtest--live-trading)
     - [General purpose](#general-purpose)
     - [Crypto 相关](#crypto-currency-focus)
     - [机器学习 / 强化学习](#machine-learning--reinforcement-learning-focused)
   - [Alpha Collections](#alpha-collections)
     - [Alpha](#alpha)
     - [套利 (Crypto)](#arbitrage-crypto)
   - [基本日常用到的库集合](#basic-libraries)
     - [基础的库libraries](#fundamental-libraries)
     - [计算图 Computation Graph](#computation-graph)
     - [其他可用的库 libraries](#alternative-libraries)
   ...
   - [分析工具](#analytic-tools)
     ...
     - [风险](#risk)
     - [优化](#optimization)
     - [时间序列分析 TimeSeries Analysis](#timeseries-analysis)
   - [可视化](#visualization)
   - [数据库](#databases)
   - [数据源](#data-source)
     - [股票 Stocks and General](#stocks-and-general)
     - [加密货币](#crypto)
   ...
   - [资源 Resources](#resources)
     ...
     - [教程](#tutorials)
     - [专业课程](#courses)
   - [其他相关的项目 Relevant Projects](#relevant-projects)
