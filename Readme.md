...
- [SPZCO](https://spzco.com) - Equity research terminal built on US public filings: congressional STOCK Act trades, executive-branch OGE disclosures, 13F institutional holdings and Form 4 insider transactions on per-stock and per-filer pages, with screeners and portfolio backtesting. Filings are free; derived analytics are paid.
