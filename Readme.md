...
- [Cipher](https://github.com/nanvel/cipher-bt) | `Python` | - Backtesting library with focus on position adjustment which allows testing complicated setups. Pythonic, extensible, well-structured, documented.
